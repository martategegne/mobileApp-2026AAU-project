          ...
          if (notifications.isEmpty) {
            return const Center(
              child: Column(
                ...
                children: [
                  Icon(Icons.notifications_off_outlined, size: 64, color: AppColors.mediumGrey),
                  SizedBox(height: 16),
                  Text('No notifications yet', style: TextStyle(color: AppColors.mediumGrey)),
                ],
              ),
            );
          }
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                leading: CircleAvatar(
                  backgroundColor: notif.isRead ? AppColors.lightGrey : AppColors.primary.withOpacity(0.1),
                  child: Icon(
                    Icons.notifications_outlined,
                    color: notif.isRead ? AppColors.mediumGrey : AppColors.primary,
                  ),
                ),
                title: Text(
                  notif.title,
